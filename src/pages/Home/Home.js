...
import { shape, func, array, bool, oneOfType, object } from "prop-types";
...
Home.propTypes = {
  ...
  recipesState: shape({
    recipesLoading: bool.isRequired,
    recipesLoadingError: oneOfType([bool, object]),
  }).isRequired,
  fetchRecipes: func.isRequired,
};
