...
Recipe.propTypes = {
  ...
  recipeState: shape({
    recipeLoading: bool.isRequired,
    recipeLoadingError: oneOfType([string, object]),
    recipeFetched: bool.isRequired,
    recipeUpdating: bool.isRequired,
    recipeUpdatingError: oneOfType([string, object]),
  }).isRequired,
  currentUserState: shape({
    isAuthenticated: bool.isRequired,
  }).isRequired,
  fetchRecipe: func.isRequired,
  addRecipeComment: func.isRequired,
};
